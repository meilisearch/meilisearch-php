...
/**
 * @phpstan-import-type RawDynamicSearchRuleTask from DynamicSearchRules
 */
trait HandlesDynamicSearchRules
{
     ...
     */
    public function updateDynamicSearchRule(UpdateDynamicSearchRuleQuery $request): array
    {
     ...
     * @return RawDynamicSearchRuleTask
     */
    public function deleteAllDynamicSearchRules(): array
    {
